...
#     RegisterUserView
from .views import ChangePasswordSecretQuestionsAnswersView, ChangePasswordSecretQuestionsView, ChangePasswordView, StoryModelViewSet, TagModelViewSet, RegisterUserView, MyStoryModelViewSet, LogoutView, \
...
router.register(r'change-password-secret-questions', ChangePasswordSecretQuestionsView, basename="change-password-secret-questions")
router.register(r'change-password-secret-questions-answers', ChangePasswordSecretQuestionsAnswersView, basename="change-password-secret-questions-answers")
